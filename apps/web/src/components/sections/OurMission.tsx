...
const OurMission = () => {
  return (
    <section id="our-mission" className="bg-primary-500 from-primary-300 via-primary-400 p-sections relative flex h-[50vh] w-full items-center justify-between gap-4 overflow-hidden  bg-gradient-to-tr from-10% via-60% to-70% py-4  lg:flex-row shadow-custom-both">
